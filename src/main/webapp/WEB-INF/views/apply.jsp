                                    ...
                                    <div class="wizard-content">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-5 text-right">
                                                <h4 id="changePoint"><input type="text" name="m_point" class="blockquote-simple text-bold text-right p-0 m-0" style="outline:none; font-size: 1.4rem;" value="0" readonly="readonly"> P</h4>
                                            </div>
                                        </div>
                                        <hr color="black">
                                        <div class="form-row">
