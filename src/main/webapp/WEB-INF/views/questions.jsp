				...
				<div class="tab-content" id="myTabContent3">
					<div class="tab-pane fade show active" id="tap1" role="tabpanel"
						...
						<div class="qna-form p-l-100 p-r-100 p-t-30">
							...
							<br>
							<hr>
							<form action="" class="cs-contents">
								<!-- Select box -->
								<div class="select-box-area p-t-50 p-b-50">
									<label class="select-box-area-label p-b-10" for="cs"
										style="font-size: 18px">문의 유형 선택 <span
										style="color: red">*</span></label> <select name="cs">
										<option value="" selected="selected">문의 유형을 알려주세요</option>
										<option value="요금제 문의">요금제 문의</option>
										<option value="결제 문의">결제 문의</option>
										<option value="수거/배송 문의">수거/배송 문의</option>
										<option value="런드렛 이용 문의">런드렛 이용 문의</option>
										<option value="세탁 문의">세탁 문의</option>
										<option value="서비스/회원 문의">서비스/회원 문의</option>
									</select>
								</div>
								<!-- end: Select box -->
								<!-- Contents -->
								<label class="cs-contents-label p-b-10" for=""
								...
								<textarea class="cs-contents-textarea" maxlength="300"
...
<!-- 								</div> -->
								...
								<button type="button" id="btn_user"
									...
									style="border-color: #13B383; font-size: 13.5px !important;"
									onclick="location.href='/qna'">문의 하기</button>
							</form>
						</div>
					</div>
