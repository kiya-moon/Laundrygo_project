						...
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">28&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이 온리 Light" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6 m-b-30">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">49&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이 온리 58" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">52&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이 온리 68" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">51&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이 온리 84" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-12 m-b-30">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">24&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="런드리 온리 70" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">5&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="런드리 온리 50" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">3&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="런드리 온리 38" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-12 m-b-30">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">39&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이&런드리 78" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">33&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이&런드리 59" >
									신청하기 Click
								</button>
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="team-member text-dark row p-10 m-0">
                           ...
                           <span><span class="highlight highlight-colored">29&#37;</span>
							...
							<div class="col-lg-12 text-center p-t-20">
								<button type="button" id="apply_click" class="btn btn-block text-small p-20" value="드라이&런드리 47" >
									신청하기 Click
								</button>
							</div>
						</div>
